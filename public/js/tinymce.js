...
!function() {
    ...
    const r = t=>{
      ...
      , l = (()=>{
        ...
        return {
            load: (e,o,n)=>{
                t.scriptLoaded ? n() : (t.listeners.push(n),
                e.getElementById(t.scriptId) || ((t,e,o,n)=>{
    ...
    class b extends HTMLElement {
        ...
        _updateEventAttr(t, o) {
            const n = t.substring(3).toLowerCase()
              , s = null !== o ? e(o) : void 0
              , i = "function" == typeof s ? s : void 0;
            this._eventHandlers[n] !== i && (this._editor && this._eventHandlers[n] && this._editor.off(n, this._eventHandlers[n]),
            i ? (this._editor && this._editor.on(n, i),
            this._eventHandlers[n] = i) : delete this._eventHandlers[n])
        }
        _updateForm() {
            if (this.isConnected) {
                const t = this.getAttribute("form")
                  , e = null !== t ? this.ownerDocument.querySelector("form#" + t) : u("form", this);
                this._form !== e && (null !== this._form && this._form.removeEventListener("formdata", this._formDataHandler),
                this._form = e,
                null !== this._form && this._form.addEventListener("formdata", this._formDataHandler))
            } else
                null !== this._form && (this._form.removeEventListener("formdata", this._formDataHandler),
                this._form = null)
        }
        _getTinymce() {
            return t.tinymce
        ...
        _getConfig() {
            ...
            return this.readonly && (o.readonly = !0),
            this.autofocus && (o.auto_focus = !0),
            delete o.target,
            delete o.selector,
            o
        }
        _getEventHandlers() {
            ...
            for (let o = 0; o < this.attributes.length; o++) {
                ...
                if (null !== n && n.name.toLowerCase().startsWith("on-")) {
                    const o = n.name.toLowerCase().substring(3)
                      , s = e(n.value);
        ...
        _doInit() {
            ...
            n.value = null !== (t = this.textContent) && void 0 !== t ? t : "";
            const s = null === (e = this.attributes.getNamedItem("id")) || void 0 === e ? void 0 : e.value;
            s && (n.id = s),
            null !== this.placeholder && (n.placeholder = this.placeholder),
            this._shadowDom.appendChild(n);
            const i = this._getConfig()
              , r = Object.assign(Object.assign({}, i), {
                ...
                setup: t=>{
                    ...
                    "function" == typeof i.setup && i.setup(t)
                }
            });
            this._getTinymce().init(r)
        }
        _getTinymceSrc() {
            var t;
        ...
        connectedCallback() {
            ...
            this._updateForm(),
            this._status === d.Raw && this._loadTinyDoInit()
        }
        ...
        set readonly(t) {
            t ? (this._editor && "readonly" !== this._editor.mode.get() && this._editor.mode.set("readonly"),
            this.hasAttribute("readonly") || this.setAttribute("readonly", "")) : (this._editor && "readonly" === this._editor.mode.get() && this._editor.mode.set("design"),
            this.hasAttribute("readonly") && this.removeAttribute("readonly"))
        }
        get placeholder() {
